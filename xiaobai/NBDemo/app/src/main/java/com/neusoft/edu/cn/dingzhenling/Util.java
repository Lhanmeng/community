...
//将字节数组中每个字节拆解成2位16进制整数
	...
	public static void saveColor(Context context, int color){
		SharedPreferences sp = context.getSharedPreferences("yours", Context.MODE_PRIVATE);
		sp.edit().putInt("color", color).commit();
	}

	public static int getColor(Context context, int defaultcolor){
		SharedPreferences sp = context.getSharedPreferences("yours", Context.MODE_PRIVATE);
